...
%%%%%%%%%%%%%%%%%%%%%%%% Cusps/Undercutting Check %%%%%%%%%%%%%%%%%%%%%%%%%
% Minimun of the absolute value of the rhopitch has to be 2 to 3 times
% greater than Rf
...
%%%%%%%%%%%%%%%%%%%%%%%%%% Check Results %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% % % Checks the rhocam and the rhopitch 
% % if min(rhocam) >= Rf
% %     display('The radius of curvature of the CAM is acceptable since it is greater than the radius of the follower.')
% % elseif rhocam() < 0
% % else
% %     display('The radius of curvature of the CAM is not acceptable since it is less than the radius of the follower.')
% % end
% % 
% % if min(abs(
